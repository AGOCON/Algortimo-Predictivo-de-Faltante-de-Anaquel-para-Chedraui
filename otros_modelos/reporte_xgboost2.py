...
with open('Reporte_General_XGBOOST.txt','w') as f:
    f.write(f'#####Calificaciones obtenidas por el algoritmo Local Cascade Ensemble puro ########## \n')
...
plt.xlabel('fpr')
plt.ylabel('tpr')
plt.title('ROC curve for the pure XGBOOST Classifier')
plt.show()
